...
2. valid_month: 프로그램이 적용되는 월 (YYYY년 M월 형식으로 반환)
   - 문서 첫 줄에 "X월 수영 프로그램" 또는 "YYYY년 X월 수영 프로그램" 형태로 나타남
   - 년도가 명시되지 않은 경우, 문서 내에서 년도를 찾아서 조합
   - 예: "2월 수영 프로그램 운영 안내" + 문서 내 "2026년" 정보 → "2026년 2월"
   - 예: "2025년 12월 수영 프로그램" → "2025년 12월"
   - 반드시 문서 첫 줄의 월을 사용하고, 다른 월로 변경하지 말 것
   - **중요**: 공지 등록일(notice_date)이 제공되면 반드시 참고할 것
     * 등록일이 "등록일자2025-10-20"이고 문서가 "11월 프로그램"이면 → "2025년 11월"
     * 등록일이 "등록일자2025-12-19"이고 문서가 "1월 프로그램"이면 → "2026년 1월" (다음해)
